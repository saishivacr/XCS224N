...
class VocabEntry(object):
    ...
    def __init__(self, word2id=None):
        ...
        self.start_of_word_char = "{"
        self.end_of_word_char = "}"
        self.start_of_word = self.char2id[self.start_of_word_char]
        self.end_of_word = self.char2id[self.end_of_word_char]
    ...
    def words2charindices(self, sents):
        """ Convert list of sentences of words into list of list of 
        ...
        # TODO: 
        #     This method should convert characters in the input sentences
        #     into their
        #     corresponding character indices using the character vocabulary
        #     char2id
        #     defined above.
        #
        #     You must prepend each word with the `start_of_word` character
        #     and append
